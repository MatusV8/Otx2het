...
bargraph_jitterdodge <- function(data, stats = NULL, x, y, group = NULL,
                            ylab = "y",  errorbar = "SEM", dotsize = 1, fill_colors = NULL,
  ...
  plot_out + coord_cartesian(clip = "off") # Prevent clipping of data points
